                ...
                item.attributes.product_finishing.data.attributes.Name
                    ...
                    <div class="content_body">
                        ...
                        <div class="download_data">
                            ...
                            <v-btn class="belgin-bold sample-btn mt-md-10" @click="navigateToCartPage(item)">Request a Sample</v-btn>
                        </div>
...
<script>
import jsonData from "~/Public/concreteData.json";
...
this.$router.push({ path: `/cart/${item.attributes.slug}` })
        ...
        getObjectByCategory(category) {
            const concreteData = jsonData.props.pageProps.products.concreteData;
            this.Products = concreteData.filter(obj => obj.attributes.slug === category);
