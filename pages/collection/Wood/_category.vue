...
<script>
import jsonData from "~/Public/woodData.json";
...
export default {
    ...
    methods: {
        ...
        getObjectByCategory(category) {
            const woodData = jsonData.props.pageProps.products.woodData;
            this.Products = woodData.filter(obj => obj.attributes.slug === category);
