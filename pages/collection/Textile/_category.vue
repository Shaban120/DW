...
<script>
import jsonData from "~/Public/textileData.json";
...
export default {
    ...
    methods: {
        ...
        getObjectByCategory(category) {
            const textileData = jsonData.props.pageProps.products.textileData;
            this.Products = textileData.filter(obj => obj.attributes.slug === category);
